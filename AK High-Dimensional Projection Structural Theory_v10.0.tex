...
x, y \in \texttt{DisconnectedComponent}
  \arrow[r, "{\texttt{Cone}(x,y)}"]
  \arrow[dr, swap, "{\texttt{Ext}^1 \ne 0}"]
& \texttt{GluingSheaf}(x,y)
  \arrow[d, "{\texttt{StratifiedRefinement}}"] \\
& \texttt{ConnectedComponent}
  \arrow[r, "{\texttt{CollapseReady}}"]
...
& \mathcal{F}_t \arrow[d, "{\mathrm{PH}_1,\, \mathrm{Ext}^1 \Rightarrow \mathtt{CollapseObstruction}(K)}"] \\
(\Delta_K, r_1, r_2) \arrow[r, dashed, "{\text{indistinct}}"]
& {\mathtt{CollapseRefined}(K)}
\end{tikzcd}
\end{center}
