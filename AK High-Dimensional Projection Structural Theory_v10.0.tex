...
% Recommended Preamble (for Overleaf + XeLaTeX)
% ===============================================
...
\setmainfont{Times New Roman}   % Set main font (adjustable)
...
% === TikZ and Diagram Tools ===
\usepackage{tikz}
\usetikzlibrary{matrix, arrows.meta, decorations.pathmorphing, cd}  % include 'cd' last
...
% === Language (Load last to avoid conflicts) ===
...
\resizebox{\textwidth}{!}{%
\begin{tikzcd}
& \texttt{CollapseValid} \arrow[dl, dashed, bend left=15, "\neg"] \\
