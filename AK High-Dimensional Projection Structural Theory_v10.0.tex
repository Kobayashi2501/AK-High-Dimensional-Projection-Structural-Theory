...
& G^\bullet \arrow[r, "g"] \arrow[d, "\mathcal{F}_{\text{Collapse}}"']
...
& \mathcal{F}(G^\bullet) \arrow[r, "\mathcal{F}(g)"']
...
& \texttt{TypeIII} \arrow[dl, "\text{add Ext}"'] \arrow[dr, "\text{add PH}"] & \\
\texttt{TypeI} \arrow[dr, "\text{add PH}"'] & & \texttt{TypeII} \arrow[dl, "\text{add Ext}"] \\
& \texttt{TypeIV} &
\end{tikzcd}
\]
\end{definition}
