...
% XeLaTeX-Optimized Preamble (Overleaf safe)
% ===============================================
...
\node (A) at (0,0) {\textbf{A:} $u(t)$};
\node (B) at (4,0) {\textbf{B:} $\mathrm{PH}_1 = 0$};
\node (C) at (0,-2) {\textbf{C:} $\mathrm{Ext}^1 = 0$};
\node (D) at (4,-2) {\textbf{D:} $u(t) \in C^\infty$};

\draw[->] (A) -- node[above] {\footnotesize Spectral Decay} (B);
\draw[->] (A) -- node[left] {\footnotesize Topological Energy} (C);
\draw[->] (B) -- node[right] {\footnotesize Functor Collapse} (D);
\draw[->] (C) -- node[below] {\footnotesize Obstruction Removal} (D);
\draw[->, dashed, bend left=20] (D) to node[above right] {\footnotesize Loop Back} (A);
\end{tikzpicture}
...
% ===========================
\section*{Chapter 5: Collapse Axiom VII--IX:\\
Functor Categories and Type-Theoretic Structures}
\addcontentsline{toc}{section}{\numberline{Chapter 5} Collapse Axiom VII--IX}
...
\begin{tikzpicture}
\node (A) at (0,0) {$X = \bigsqcup X_i$};
\node (B) at (3,0) {$\mathcal{F}_X$};
\node (C) at (6,0) {$\mathcal{F}_X^{(\infty)}$};
\node (D) at (6,-2) {$\mathcal{C}_{\text{collapse}}$};
\node (E) at (1.5,-2) {Obstructed Geometry};

\draw[->] (A) -- node[above] {Lifting $\Pi$} (B);
\draw[->] (B) -- node[above] {Refinement} (C);
\draw[->] (C) -- node[right] {Collapse} (D);
\draw[->, bend left=20, dashed] (E) to node[above right] {Resolution} (C);
\draw[->, bend right=20] (A) to node[left] {$\delta \in \mathrm{Ext}^1$} (E);
\end{tikzpicture}
...
% =============================================================
% Appendix H⁺: Collapse Functor Composition and Identity
% =============================================================

\section*{Appendix H$^{+}$: Collapse Functor Composition and Identity}
\addcontentsline{toc}{section}{Appendix H⁺: Collapse Functor Composition and Identity}
...
% =============================================================
% Appendix I: Collapse Axiom Extensions and Structural Stability
% =============================================================
...
% =============================================================
% Appendix I⁺: Derived Collapse and Ext-Category Formalization
% =============================================================

\section*{Appendix I$^{+}$: Derived Collapse and Ext-Category Formalization}
\addcontentsline{toc}{section}{Appendix I⁺: Derived Collapse and Ext-Category Formalization}
...
\begin{tikzpicture}[>=stealth, scale=1, every node/.style={align=center}]
  % ノード定義
  \node (A) at (0,0) {\textbf{A:}\\ $u(t)$};
  \node (B) at (6,0) {\textbf{B:}\\ $\mathrm{PH}_1 = 0$};
  \node (C) at (0,-3) {\textbf{C:}\\ $\mathrm{Ext}^1 = 0$};
  \node (D) at (6,-3) {\textbf{D:}\\ $u(t) \in C^\infty$};
  ...
  \draw[->] (B) -- node[right] {\footnotesize Functor Collapse} (D);
  \draw[->] (C) -- node[below] {\footnotesize Obstruction Removal} (D);
  \draw[->, dashed, bend left=25] (D) to node[above right] {\footnotesize Loop Back} (A);
\end{tikzpicture}
...
\begin{tikzpicture}[>=stealth, scale=1, every node/.style={align=center}]
  % ノード配置
  \node (Ft) at (0,0) {$\mathcal{F}_t$};
  \node (Fuk) at (6,0) {$\mathcal{F}_{\mathrm{Fuk}}(X^\vee) \in D^\pi \mathcal{F}(X^\vee)$};
  \node (AK) at (0,-3) {Smooth filtered AK sheaf};

  % 矢印
  \draw[->] (Ft) -- node[above] {\footnotesize Collapse Functor $\mathcal{F}_{\mathrm{Collapse}}^{\mathrm{HMS}}$} (Fuk);
  \draw[->] (Ft) -- node[left] {\footnotesize $\mathrm{PH}_1 = 0,\; \mathrm{Ext}^1 = 0$} (AK);
  \draw[->] (AK) -- node[above right] {\footnotesize Mirror realization} (Fuk);
\end{tikzpicture}
...
% =============================================================
% Appendix U⁺: Semantic Collapse Failure Typing and Complement Structures
% =============================================================

\section*{Appendix U$^{+}$: Semantic Collapse Failure Typing and Complement Structures}
\addcontentsline{toc}{section}{Appendix U⁺: Semantic Collapse Failure Typing and Complement Structures}
...
\begin{adjustwidth}{0em}{0em}  % 必要に応じて調整
\begin{lstlisting}[language=Coq]
...
% =============================================================
% Appendix TT⁺: Type-Theoretic Collapse Realization Supplement
% =============================================================

\section*{Appendix TT⁺: Type-Theoretic Collapse Realization Supplement}
\addcontentsline{toc}{section}{Appendix TT⁺: Type-Theoretic Collapse Realization Supplement}
...
\addcontentsline{toc}{subsection}{TT⁺.7 CollapseClassifierCategory — Typal Classification as a Category}
...
\addcontentsline{toc}{subsection}{TT⁺.8 Summary and Integration}
