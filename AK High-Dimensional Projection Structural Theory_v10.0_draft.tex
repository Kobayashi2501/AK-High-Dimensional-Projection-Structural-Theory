...
is precisely defined in Appendix T.7 for use in formal verification environments (e.g., Coq, Lean).  
...
\subsection*{T.7 Coq-Compatible Collapse Causality Definitions}
\addcontentsline{toc}{subsection}{T.7 Coq-Compatible Collapse Causality Definitions}
...
\subsection*{T.8 Disconnected Collapse and Refinement Formalization}
\addcontentsline{toc}{subsection}{T.8 Disconnected Collapse and Refinement Formalization}
...
\subsection*{T.9 Ext-Vanishing Collapse Structures}
\addcontentsline{toc}{subsection}{T.9 Ext-Vanishing Collapse Structures}
