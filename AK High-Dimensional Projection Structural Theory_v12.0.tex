...
\usepackage{tikz-cd}
\usetikzlibrary{
  matrix, arrows.meta, decorations.pathmorphing, calc, positioning,
...
\subsection*{8.3 Hierarchical Obstruction Analysis and Iwasawa-Theoretic Refinement}
...
\begin{itemize}
    ...
    \item Arithmetic invariants (class groups, units);
...
\paragraph{Refined Collapse Chain.}
The obstruction elimination proceeds as:

\[
\mathcal{F} \longrightarrow \mathcal{P}(\mathcal{C}) \longrightarrow \mathcal{F}_{\mathrm{Iw}} \longrightarrow \mathcal{G} \longrightarrow \mathcal{G}_{\mathrm{triv}},
\]
...
\begin{itemize}
    ...
    \item \( \mathcal{G} \) — associated group;
...
\subsection*{8.5 Type-Theoretic Formalization}

The layered collapse conditions are encoded as:
...
Here, \texttt{Stratified}(\( \mathcal{F} \)) encodes projection-induced geometric decomposition, aligned with the generalized Geometrization perspective.
...
\subsection*{M$^{+}$.3 Functorial Collapse and Group Equivalence with Iwasawa Refinement}
...
under the following strengthened collapse conditions:
...
The Ext$^1$-collapse simplifies group-theoretic obstructions, while Iwasawa-theoretic refinement ensures arithmetic precision in this simplification process.

---

\subsection*{M$^{+}$.4 Coq-Style Encoding of Group-Theoretic Langlands Collapse with Iwasawa Layer}
...
(* Langlands collapse axioms with Iwasawa refinement *)
...
% =============================================================
% Z.8 Advanced Structural Extensions (Spectral, Motivic, High-Categorical)
% =============================================================
...
% =============================================================
% Z.9 Cumulative Collapse Stability Theorems
% =============================================================
...
% =============================================================
% Z.X Final Collapse Completion and Q.E.D. Statement
% =============================================================
