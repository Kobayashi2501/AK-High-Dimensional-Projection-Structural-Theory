...
Importantly, $\mathcal{C}_{\mathrm{nontriv}}$ is not an informal "外部不定領域" (external undefined region), but a rigorously ZFC-definable subcategory of $\mathsf{Filt}(\mathcal{C})$, encoding arithmetic or group-theoretic obstructions such as:
