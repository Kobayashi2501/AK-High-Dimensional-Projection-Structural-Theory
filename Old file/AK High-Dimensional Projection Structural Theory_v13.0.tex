...
\usepackage{tikz-cd}
\usetikzlibrary{
  matrix, arrows.meta, cd, decorations.pathmorphing, calc, positioning,
  decorations.markings, shapes.geometric, arrows
}
\usepackage{amscd}
...
% =============================================================
% Appendix F$^{+}$: Ext-Vanishing Convergence and Collapse Failure Classification
% =============================================================

\section*{Appendix F$^{+}$: Ext-Vanishing Convergence and Collapse Failure Classification}
\addcontentsline{toc}{section}{Appendix F$^{+}$: Ext-Vanishing Convergence and Collapse Failure Classification}
...
% =============================================================
% Appendix X.2: Proposition and Theorem Compendium (Fully Integrated and Formally Augmented)
% =============================================================
...
% =============================================================
% Appendix Z: Full Formalization of AK Collapse Theory v13.0 (Fully Reinforced and Consolidated)
% =============================================================
...
% =============================================================
% Z.10 Recursive Collapse Closure and Proof Path Synthesis (Fully Reinforced)
% =============================================================
...
% -------------------------------------------------------------
% Z.10.1 Collapse Recursion Schema (Lean-Compatible Logic)
% -------------------------------------------------------------
...
\vspace{0.8em}
This schema is now extended with:
- Spectral convergence-based collapse (\texttt{SpectralEnergyDecay});
- Information-theoretic collapse success (\texttt{CollapseSuccessful});
thus ensuring completeness of analytic and entropic cases.

% -------------------------------------------------------------
% Z.10.2 Collapse Proof Path Diagram (Updated TikZ-based)
% -------------------------------------------------------------

\subsubsection*{Z.10.2 Collapse Proof Path Diagram (Reinforced)}

\begin{center}
\resizebox{\textwidth}{!}{
\begin{tikzpicture}[node distance=2.5cm, every node/.style={align=center}]
% --- your nodes and arrows below ---
\node (PH1) [draw, rounded corners, minimum width=3.5cm, minimum height=1cm] {$\mathrm{PH}_1(F) = 0$};
\node (Ext1) [below left=of PH1, draw, rounded corners, minimum width=3.5cm, minimum height=1cm] {$\mathrm{Ext}^1(F) = 0$};
\node (Grp) [below right=of PH1, draw, rounded corners, minimum width=3.5cm, minimum height=1cm] {$\mathrm{GroupCollapse}(G)$};
\node (Ready) [below=of Ext1, xshift=2.4cm, draw, thick, rounded corners, fill=blue!10, minimum width=4cm, minimum height=1.2cm] {\textbf{Collapse Ready}};
\node (Spectral) [left=3.2cm of Ext1, draw, dashed, minimum width=3.2cm, minimum height=1cm] {SpectralEnergy $< \varepsilon$};
\node (Info) [right=3.2cm of Grp, draw, dashed, minimum width=3.2cm, minimum height=1cm] {KL-Divergence $> 0$};

\draw[->, thick] (PH1) -- node[left] {\small PH$\to$Ext} (Ext1);
\draw[->, thick] (Ext1) -- node[below left] {\small Ext$\to$Group} (Grp);
\draw[->, thick] (Grp) -- node[right] {\small Group$\to$Ready} (Ready);
\draw[dashed, ->] (Spectral) -- node[above right] {\small Spectral Case} (Ready);
\draw[dashed, ->] (Info) -- node[above left] {\small Entropic Collapse} (Ready);
\end{tikzpicture}
}
\end{center}
...
\vspace{0.8em}
This diagram visualizes both traditional homological collapse paths and newer analytic/informational extensions.

% -------------------------------------------------------------
% Z.10.3 Semantic Closure and Q.E.D. Recursion (Coq-style)
% -------------------------------------------------------------
...
% -------------------------------------------------------------
% Z.10.4 Summary and Logical Closure (Unified)
% -------------------------------------------------------------
...
% =============================================================
% Z.11 Final Collapse Completion and Unified Q.E.D. Theorem (Fully Reinforced Version)
% =============================================================
