...
\begin{aligned}
& X 
  \xrightarrow{\mathcal{P}} \mathbb{T}^N 
  \xrightarrow{\text{Sublevel Filtration}} 
  \{ X_r := \theta \mid |\mathcal{P}(x)| \leq r \} 
  \xrightarrow{\text{Barcode}_k} 
  PH_k(t) \to 0 \\
& \quad \searrow\!\!\!\!\!\!\!\!\!\!\nearrow\quad \mathrm{Ext}^1(F,G)
\end{aligned}
\]
...
A9 & Appendix L.15 & Functorial embedding of AI into collapse logic \\
C1–C6 & Appendix J, M & Abstract collapse classes and propagation logic \\
\end{tabular}
