...
& \[ \lim_{j \to \infty} E_j(t) = 0, \quad \forall t > T_0, \]  \\
& then this implies categorical collapse:  \\
& \[ \mathrm{Ext}^1(Q, \mathcal{F}_t) = 0, \]  \\
& where $\mathcal{F}_t \in D^b(\mathsf{Filt})$ is the derived sheaf associated with the topological structure  \\
& of the sublevel sets $\{x \mid |u(x,t)| \leq r\}$.  \\
& \textit{[See Appendix~C.3]} \\
\textbf{A8} & \textbf{AI Classification Collapse Axiom}:  \\
& If an AI classifier trained on PH–Ext correspondence consistently labels  \\
& a filtered complex as ``trivial,'' then this implies:  \\
...
A7 & Appendix C.3 & Spectral collapse to Ext vanishing \\
A8 & Appendix L.13--L.14 & AI classifier judgment of PH–Ext triviality \\
