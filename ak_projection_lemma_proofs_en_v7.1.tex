% ===========================
% AK High-Dimensional Projection Structural Theory 7.2
% ===========================
...
A9 & BSD Collapse confirms structural Ext–PH–Sha chain & Appendix Z.8 \\
\bottomrule
\end{tabular}
...
\begin{tabular}{>{\raggedright\arraybackslash}p{3.5cm} >{\raggedright\arraybackslash}p{3.5cm} >{\raggedright\arraybackslash}p{4cm} >{\raggedright\arraybackslash}p{2.5cm}}
\toprule
...
BSD Collapse & Rational points on elliptic curves & PH → Ext → $\Sha = 0$ & Appendix Z.8 \\
...
\subsection*{Z.4 Ext–PH–Smoothness Collapse Diagram (Causal Structure)}
...
\textbf{Figure Z.4.} Causal Collapse Flow: PH-triviality implies Ext-vanishing, enabling gluing and categorical smoothness.
\end{center}
